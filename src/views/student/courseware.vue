<template>
  <div id="courseware">
    <div class="coursewareMain">
      <div class="coursewareTitle">
        <h2>教学课件</h2>
      </div>
      <div class="coursewareForm">
        <el-table
          :data="tableData"
          style="width: 100%"
        ...
        >
          ...
          <el-table-column
            class-name="coursewareName"
            prop="coursewareName"
            label="课件名称"
            width="300"
          >
          </el-table-column>
          <el-table-column prop="coursewareIntroduce" label="课件简介">
          </el-table-column>
          <el-table-column
            class-name="coursewareBtn"
            prop="coursewareBtn"
            label="查看"
            width="100"
          >
