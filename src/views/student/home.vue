...
export default {
  ...
  data() {
    return {
      ...
      homeText1Content: "",
      homeText2Content: "",
      homeText2ImgSrc: require("../../assets/images/homeText2.jpg"),
  ...
  created() {
    ...
    if (getCookie("userToken") === "") {
      ...
      this.axios
        .get("http://129.204.189.149:8089/administrator/HomePage")
        .then(response => {
          this.homeText1Content =
            " 待上传 " ||
            response.data.message[
              (this.homeText1Content = response.data.message.length - 1)
            ].courseIntroduction;
          this.homeText2Content =
            " 待上传 " ||
            response.data.message[
              (this.homeText2Content = response.data.message.length - 1)
            ].courseLeader;
