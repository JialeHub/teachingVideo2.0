...
export default {
  ...
  data() {
    return {
      imgList: [
        { id: 0, idView: require("../../../assets/images/b1.jpg") },
        { id: 1, idView: require("../../../assets/images/b2.jpg") },
        { id: 2, idView: require("../../../assets/images/b3.jpg") },
        { id: 3, idView: require("../../../assets/images/b4.jpg") }
      ],
      homeText1Content: "",
      homeText2Content: "",
      homeText2ImgUrl: require("../../../assets/images/loading2.gif"),
      classReviewImgList1: require("../../../assets/images/classView.png"),
      classReviewImgList2: require("../../../assets/images/classView.png"),
      classReviewImgList3: require("../../../assets/images/classView.png"),
      classReviewContent1: "Test",
      classReviewContent2: "Test",
      classReviewContent3: "Test"
    };
  },
  methods: {
    classReviewBox1: () => {
  ...
  created() {
    ...
    homeApi()
      .then(response => {
        ...
        this.homeText1Content = response.data.message.courseIntroduction;
        if (response.data.message.photo) {
          this.homeText2ImgUrl = response.data.message.photo;
        }
      })
      .catch(error => {
        this.homeText1Content = " 获取失败 ";
        this.homeText2Content = " 获取失败 ";
        console.log(error);
      });
  }
};
