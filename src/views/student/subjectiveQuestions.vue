<template>
  <div id="subjectiveQuestions">
    <div class="subjectiveQuestions">
      <h2 id="subjectiveQuestionsTitle">主观题</h2>
...
export default {
  ...
  created() {
    window.subjectiveQuestions_this = this;
    ...
    .el-tabs {
      ...
      .el-tabs__content {
        ...
        .content {
          ...
          .subjectiveQuestionsIn:first-of-type {
            margin-top: 0;
          }
          .answerBtn {
